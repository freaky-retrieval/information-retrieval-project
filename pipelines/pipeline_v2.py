...
#     ):
#         super(PipelineV2, self).__init__(s3_storage, downloader, crawler)
...
#         logging.info("Pipeline V2 is serving the query.")
#         return super(PipelineV2, self).serve(query)
...
# instance = PipelineV2.from_env(with_generator=True, with_llm=True)
